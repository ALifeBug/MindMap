...
<div class="container-fluid mt70 plr15">
	...
	<div style="border: 2px solid #1F4963; padding: 6px; margin-bottom: 30px;">
		...
		<ul>
			...
			<li>
				You can now send and receive incremental changes to a database instead of sending the whole model,
				with <a>Model.toIncrementalJson</a> and <a>Model.applyIncrementalJson</a>.
			</li>
			<li>
				Tooltips are now shown on touch devices when the user clicks on an object with a <a>GraphObject.toolTip</a>
				or in the diagram background when <a>Diagram.toolTip</a> is an <a>Adornment</a>.
			</li>
		</ul>
	</div>
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>
							<a>Part.ensureBounds</a>, to measure and arrange the part's visual tree and
							make sure that the width and height are real numbers
						</li>
					</ul>
	...
	<ul>
		...
		<li>
			<a>Diagram.makeSvg</a> now includes a clipping region to fix IE's SVG behavior,
