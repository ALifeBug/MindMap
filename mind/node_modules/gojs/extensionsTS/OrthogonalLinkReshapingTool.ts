...
export class OrthogonalLinkReshapingTool extends go.LinkReshapingTool {
  ...
  */
	public makeAdornment(pathshape: go.Shape): go.Adornment {
		...
		var adornment = super.makeAdornment.call(this, pathshape);
  ...
  * @this {OrthogonalLinkReshapingTool}
  */
	public reshape(newpt: go.Point) {
		var link: any = this.adornedLink;
  ...
  * @this {OrthogonalLinkReshapingTool}
  */
	public makeSegmentDragHandle(link: go.Link, adornment: go.Adornment, index: number) {
