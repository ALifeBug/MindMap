...
export class Inspector {
  ...
  private declaredProperties: { [index: string]: any } = {};
	...
	constructor(divid: string, diagram: go.Diagram, options: Object) {
		...
		if (options !== undefined) {
			if ((<any>options)["includesOwnProperties"] !== undefined) this.includesOwnProperties = (<any>options)["includesOwnProperties"];
			if ((<any>options)["properties"] !== undefined) this.declaredProperties = (<any>options)["properties"];
			if ((<any>options)["inspectSelection"] !== undefined) this.inspectsSelection = (<any>options)["inspectSelection"];
  ...
  public static showIfPresent(data?: go.Part, propname?: string) {
	...
	*/
	public inspectObject(object?: Object) {
	...
	*/
	public canShowProperty(propertyName: string, propertyDesc: any, inspectedObject: Object): boolean {
	...
	* @return {Array.<number>}
	*/
	public convertToArrayOfNumber(propertyValue: string): Array<number> {
